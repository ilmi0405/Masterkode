...
# it runs both sequential and parallel modes 7 times, computes the median
# energy consumption (µJ) and execution time (s), and saves the results in a CSV file.
#
# Usage: ./run_experiments.sh

# --- Configuration ---
# Relative path to the RAPL energy file (from MASTERKODE folder)
