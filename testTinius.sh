...
for ALGORITHM in "${ALGORITHMS[@]}"; do
    if [ "$ALGORITHM" = "matrix" ]; then
        ...
        time_idx=3
        echo "N,multiplication_type,mode,threads,pkg_energy,core_energy,time" > "$CSV_LOGFILE"
        ...
        for mult in "${mult_types[@]}"; do
            for N in "${Ns[@]}"; do
                ...
                echo "$N,$mult,seq,,$seq_pkg_energy_median,$seq_core_energy_median,$seq_time_median" >> "$CSV_LOGFILE"
                ...
                for thread in "${thread_counts[@]}"; do
                    ...
                    echo "$N,$mult,par,$thread,$par_pkg_energy_median,$par_core_energy_median,$par_time_median" >> "$CSV_LOGFILE"
        ...
        time_idx=2
        echo "N,mode,threads,pkg_energy,core_energy,time" > "$CSV_LOGFILE"
        ...
        for N in "${Ns[@]}"; do
            ...
            echo "$N,seq,,$seq_pkg_energy_median,$seq_core_energy_median,$seq_time_median" >> "$CSV_LOGFILE"
            ...
            for thread in "${thread_counts[@]}"; do
                ...
                echo "$N,par,$thread,$par_pkg_energy_median,$par_core_energy_median,$par_time_median" >> "$CSV_LOGFILE"
